    ...
    <div className="flex justify-between items-center px-14 h-14  bg-[#212121] opacity-95 sticky top-0 z-50">
      <div className="flex gap-8 items-center text-2xl">
        ...
        <div className="flex gap-1 items-center justify-center">
          <BsYoutube className="text-3xl text-blue-600" />
          <span className="text-2xl ">ZainFlix</span>
        </div>
      </div>
      ...
      <div className="flex gap-8 items-center text-xl">
        ...
        <div className="relative">
          <BsBell />
          <span className="absolute bottom-2 left-2 text-xs bg-blue-600 rounded-full px-1">
            {" "}
            9+{" "}
          </span>
        </div>
        <img
          src="https://mymodernmet.com/wp/wp-content/uploads/2023/06/bokeh-effect-thumbnail.jpg"
          alt="profile logo"
